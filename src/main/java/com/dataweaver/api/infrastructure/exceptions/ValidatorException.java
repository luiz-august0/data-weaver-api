package com.dataweaver.api.infrastructure.exceptions;
...
public class ValidatorException extends RuntimeException {
    ...
    public static String mountMessageToGreaterThanZeroField(String portugueseField) {
        return "O campo " + portugueseField + " deve ser maior que 0";
    }
