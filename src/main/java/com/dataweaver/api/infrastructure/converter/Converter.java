package com.dataweaver.api.infrastructure.converter;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.fasterxml.jackson.annotation.JsonProperty;
import com.dataweaver.api.infrastructure.annotations.ObjectFieldsOnly;
...
import com.dataweaver.api.utils.ClassUtil;
...
public class Converter {
    ...
    public static <Entity extends AbstractEntity, DTO extends AbstractDTO<Entity>> DTO convertEntityToDTO(Entity entity, Class<DTO> dtoClass) {
        try {
            if (Utils.isEmpty(entity)) return null;
